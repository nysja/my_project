		...
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/company/add') }}">
						{{ csrf_field() }}
						...
						<div class="form-group{{ $errors->has('company_person') ? ' has-error' : '' }}">
							...
							<div class="col-md-6">
								<input id="company_person" type="text" class="form-control" name="person" value="{{ old('company_person') }}" required autofocus>
						...
						<div class="form-group{{ $errors->has('company_phone') ? ' has-error' : '' }}">
							...
							<div class="col-md-6">
								<input id="company_phone" type="text" class="form-control" name="phone" value="{{ old('company_phone') }}" required autofocus> 
